...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/request_style.css?v=<?php echo time();?>">
</head>
<body>
						...
						<tbody>
							<?php 
								...
								if(isset($_POST['search'])){
									...
									$selectquery = "select Fname, Mname, Lname, Gender, Bloodgroup, Bdate, Address, City, Mobile1, Mobile2 from donor where Bloodgroup = '$bloodtype' and Username != '$usrnm'";
